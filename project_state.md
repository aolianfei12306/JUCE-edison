...
| 项目 | 值 |
|------|-----|
| **阶段** | P4: 信息显示增强 (File Info Status Bar) |
| **完成度** | ~92% (P0: 100%, P1: 100%, P2: 100%, P3: 100%, P4: 10%) |
| **最后更新** | 2026-05-11 19:49 CST |
...
1. **P4-002: Windows 实机测试** — 验证 DragExport、录音等功能在 Windows 上的表现。
2. **P4-003: 频谱视图长文件优化** — 长音频文件的 STFT 内存上限优化。
